...
namespace BugTracker.API.Data
{
    ...
    {
        public static List<Priority> GetPriorities { get; private set; } = new List<Priority>
        {
        ...
        public static List<Status> GetStatuses { get; private set; } = new List<Status>
        {
        ...
        public static List<Category> GetCategories { get; private set; } = new List<Category>
        {
            new Category { Name = "UI", Color = "#1f873a"},
            new Category { Name = "API", Color = "#9b6d17" }
        };

        public static List<Role> GetRoles { get; private set; } = new List<Role>
        {
            new Role { Name = "Admin", Color = "#1f873a"},
            new Role { Name = "Tester", Color = "#904de2" }
        };

        public static List<AppUser> GetUsers { get; private set; } = new List<AppUser>
        {
            new AppUser
            {
